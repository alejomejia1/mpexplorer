Blockly.defineBlocksWithJsonArray([
    ...
    {
      "type": "create_adc",
      "message0": "Create ADC %1 on Pin %2",
...
Blockly.Python['create_digital_out'] = function(block) {
  ...
  Blockly.Python['create_adc'] = function(block) {
    ...
    var value_pinvar = Blockly.Python.valueToCode(block, 'pinvar', Blockly.Python.ORDER_ATOMIC);
    // TODO: Assemble Python into code variable.
    Blockly.Python.provideFunction_(
        'import_adc', ['from machine import ADC']);

    var code = variable_adcvar + ' = ADC(Pin(' + value_pinvar + '))\n' + variable_adcvar + '.atten(ADC.ATTN_11DB)\n';
    return code;
  };
